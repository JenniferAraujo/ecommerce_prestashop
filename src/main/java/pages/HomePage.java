...
public class HomePage {
	...
	public int obterQuantidadeProdutosNoCarrinho() {
		String quantidadeProdrutosNoCarrinho = driver.findElement(textoProdutosNoCarrinho).getText();
		quantidadeProdrutosNoCarrinho = quantidadeProdrutosNoCarrinho.replace("(", "");
		quantidadeProdrutosNoCarrinho = quantidadeProdrutosNoCarrinho.replace(")", "");

		int qtdProdutosNoCarrinho = Integer.parseInt(quantidadeProdrutosNoCarrinho);
